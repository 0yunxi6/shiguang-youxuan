...
public class ProductReviewController {
    ...
    @PutMapping("/reviews/{id}/append")
    public Result<?> append(@PathVariable Long id, @RequestBody java.util.Map<String, String> body) {
        return reviewService.appendReview(id, body == null ? null : body.get("content"));
    }
}
