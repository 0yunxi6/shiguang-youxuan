...
@Configuration
public class ProductReviewTableInitializer {

    @Bean
    public CommandLineRunner ensureProductReviewTable(DataSource dataSource) {
        return args -> {
            try (Connection connection = dataSource.getConnection();
                ...
                throw new IllegalStateException("Failed to initialize product_review table", ex);
            }
        };
    }
}
